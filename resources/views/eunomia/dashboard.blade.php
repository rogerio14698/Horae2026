...
@section('content')
  ...
  @include('eunomia.includes.tareas')

            @if(!\Auth::user()->isRole('cliente'))
                <div class="col-md-6 fichaje-card">
                    ...
                    <!-- AQUI SE INCLUYE LAS VACACIONES -->
                    @include('eunomia.includes.holidays') 

                    <div class="card card-primary card-outline movil ">
                        <div class="card-header" style="background-color:#F2F2F2">
                            <h3 class="card-title fuente-negro">
                                <i class="fas fa-calendar">
                                </i> Calendario de mis tareas, vacaciones y días festivos</h3>
